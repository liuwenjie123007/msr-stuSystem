...
public class AttendanceServiceImpl implements AttendanceService {
	...
	public int insert(Attendance attendance) {
		if(!StringUtil.isEmpty(attendance.getStuId())) {
			Student student = studentMapper.selectByPrimaryKey(attendance.getStuId());
			attendance.setCompanyId(student.getCompanyId());
			attendance.setClazzId(student.getClazzId());
			
			if(StringUtil.isEmpty(attendance.getA1())) attendance.setA1("X");
			if(StringUtil.isEmpty(attendance.getA2())) attendance.setA2("X");
			if(StringUtil.isEmpty(attendance.getA3())) attendance.setA3("X");
			if(StringUtil.isEmpty(attendance.getA4())) attendance.setA4("X");
			if(StringUtil.isEmpty(attendance.getA5())) attendance.setA5("X");
			if(StringUtil.isEmpty(attendance.getA6())) attendance.setA6("X");
			if(StringUtil.isEmpty(attendance.getA7())) attendance.setA7("X");
			if(StringUtil.isEmpty(attendance.getA8())) attendance.setA8("X");
		}
		return attendanceMapper.insert(attendance);
	}
