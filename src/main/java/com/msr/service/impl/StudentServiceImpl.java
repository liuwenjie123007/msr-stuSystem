...
public class StudentServiceImpl implements StudentService {
    ...
    public StudentExample queryStudentExample(Page page,Student student) {
		...
		//设置排序字段
		studentExample.setOrderByClause("stu_beginTime DESC");//注意：排序使用的是sql中的列名
		//设置分页参数
	...
	public int add(Student student) {
		...
		if(StringUtil.isEmpty(student.getStuBegintime())) {
			student.setStuBegintime(clazz.getClazzStarttime());
		}else {
			student.setStuBegintime(student.getStuBegintime());
		}
