	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'macCode',title:'MAC值',width:200},
			{ field:'operate',title:'清空MAC码',width:100,
				formatter:function(value, row, index){
					var str = '<a href="javascript:clearMac()" name="opera" class="easyui-linkbutton" ></a>';
					return str;
			}}
		]],
		onLoadSuccess:function(data){  
			$('.authority-edit').linkbutton({text:'编辑权限',plain:true,iconCls:'icon-edit'});
			$("a[name='opera']").linkbutton({text:'',plain:true,iconCls:'icon-advancedsettings'});
		 }  
	});
	
	function clearMac(){
		//获取行的username值
		var username = $('#data-datagrid').datagrid('getSelected').username;
