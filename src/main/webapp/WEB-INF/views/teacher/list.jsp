...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div id="wu-toolbar">
        <div class="wu-toolbar-button">
        	...
        	<div class="wu-toolbar-search" <c:if test="${role.id eq 2 }">style="display: none;"</c:if>>
        			<label>班级名称:</label> 
		            <input id="search-clazzName"  class="easyui-combobox"  data-options="editable: false,valueField:'clazzId',textField:'clazzName',url:'${pageContext.request.contextPath}/admin/clazz/getClazzNameList'" style="width:150px" />
		            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
		            <label>授课老师:</label> 
       ...
       <table cellpadding="8">
	            ...
	            <tr>
	             ...
	             <tr>
	                ...
	                <td width="60" align="right">授课班级:</td>
	                <td>
	                	<input id="edit-clazzId" name="clazzId" 
	                	<c:if test="${role.id eq 2 }">
	                		disabled="disabled"
	        			</c:if>  
	        			class="easyui-combobox" data-options="editable: false,valueField:'clazzId',textField:'clazzName',url:'${pageContext.request.contextPath}/admin/clazz/getClazzNameList'" style="width: 210px;" />
	                </td>
	            </tr>
	            <tr>
	                <td width="60" align="right">离职日期:</td>
	                <td><input type="text" id="edit-leavedate" 
	                	<c:if test="${role.id eq 2 }">
	                		disabled="disabled"
	        			</c:if>  
	        			name="leavedate" class="easyui-datebox" editable="fasle"  style="width: 210px;"/></td>
	                ...
	                <td>
	                	...
	                	<c:if test="${role.id eq 2 }">
	                	 ...
	                	 name="hiredate"  class="easyui-datebox"  data-options="editable: false,valueField:'teacherId',textField:'teacherName',url:'${pageContext.request.contextPath}/admin/teacher/getTeacherNameList'" style="width: 210px;" />
	                </td>
	            </tr>
	            <tr>
	                ...
	                <td>
			            ...
			            editable="fasle" id="edit-teacherStatus" name="teacherStatus" 
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'clazzId',title:'授课班级',width:150,sortable:true,
				formatter: function(value,row,index){
			...
			{ field:'teacherStatus',title:'状态',width:50,
				formatter:function(value,row,index){
					if (value == 1) {
