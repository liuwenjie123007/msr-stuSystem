...
<div id="importDialog" style="padding: 10px">  
   	<!-- <form action="importExcel" method="POST" enctype="multipart/form-data">  
   		<input type="file" name="textFile"  id="textFile" data-options="required:true,min:0,precision:2, missingMessage:'请选择文件',prompt:'选择文件'" style="width:200px;" />
	    <input type="submit" class="easyui-linkbutton" value="上传" />  
	  </form> -->
